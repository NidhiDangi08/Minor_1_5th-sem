...
SECRET_KEY = 'django-insecure-w)i9$v@#ymz^b8p5%mr@5ow7_*sa&d4+4hzs(_i*wqtl9gmp%l'
...
# add manually  and now run makemigratons and migrate
...
# import for media or images access  
import os
